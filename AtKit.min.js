...
a),d.internal.__baseURL="https://ssl.atbar.org/c/",d.internal.__APIURL="https://ssl.atbar.org/a/",d.internal.__pluginURL="https://ssl.atbar.org/plugins/"})();a.getVersion=function(){return d.internal.__version.toFixed(1)+"."+d.internal.__build};a.isRendered=function(){return d.internal.__invoked};a.getResourceURL=function(){return d.internal.__resourceURL};a.getPluginURL=function(){return d.internal.__pluginURL};a.setName=function(d){a.settings.name=d};a.setAbout=function(d){a.settings.about=d};a.setLogo=
function(d){a.settings.logoURL=d};a.setCSS=function(d,e){a.__CSS[d]=e};a.setLanguage=function(a){d.internal.language=a};a.getLanguage=function(){return d.internal.language};a.addLocalisation=function(a,e,g){d.internal.localisations[a][e]=g};a.addLocalisationMap=function(h,e){d.internal.localisations[h]=a.$.extend(!0,d.internal.localisations[h],e)};a.localisation=function(a){return"undefined"==typeof d.internal.localisations[d.internal.language]?d.internal.localisations[d.internal.defaultLanguage][a]:
"undefined"==typeof d.internal.localisations[d.internal.language][a]?"{no value set for key "+a+" in language "+d.internal.language+"}":d.internal.localisations[d.internal.language][a]};a.addFix=function(d,e){a.__env.siteFixes.push({regex:d,f:e})};a.addScript=function(d,e){"undefined"!=typeof a.$?0<a.$('script[src="'+d+'"]').length||a.$.getScript(d,e):t("",d)};a.addStylesheet=function(d,e){a.$("head").append(a.$("<link>",{rel:"stylesheet",href:d,type:"text/css",id:e}))};a.addFn=function(d,e){a.__env.global.fn[d]=
e};a.addCloseFn=function(d,e){a.__env.global.closeFn[d]=e};a.addResetFn=function(d,e){a.__env.global.resetFn[d]=e};a.addDialog=function(d,e,g){a.__env.global.dialogs[d]={title:e,body:g}};a.addButton=function(h,e,g,j,m,n,l){"undefined"==typeof a.__env.buttons[h]&&(a.__env.buttons[h]={icon:g,tooltip:e,action:j,dialogs:m,functions:n},null!=l&&(a.__env.buttons[h]=a.$.extend(!0,a.__env.buttons[h],l)),d.internal.__invoked&&(a.$(o(h)).appendTo("#sbar"),k()))};a.removeButton=function(h){delete a.__env.buttons[h];
d.internal.__invoked&&(j("remove button "+h),a.$("#at-btn-"+h).remove())};a.addSpacer=function(d){"undefined"==typeof d&&a.$(a.__templates.spacer).appendTo("#sbar");if(!isNaN(d))for(i=0;i<d;i++)a.$(a.__templates.spacer).appendTo("#sbar");k()};a.addSeparator=function(){a.$(a.__templates.separator).appendTo("#sbar");k()};a.importPlugins=function(h,e){var g=h instanceof Array?h.join(","):h;a.addScript(d.internal.__pluginURL+g+".js",e)};a.addPlugin=function(a){d.internal.plugins[a].payload()};a.registerPlugin=
function(a,e,g){d.internal.plugins[a]={payload:e,metadata:g}};a.listPlugins=function(){var a=[];for(p in d.internal.plugins)a.push(p);return a};a.getPluginMetadata=function(a){return d.internal.plugins[a].metadata};a.show=function(d,e){d=a.$("<div>",{"class":"userDialog"}).append(a.$("<h2>",{html:d.title}),a.$("<p>",{html:d.body}));a.$("body").find(".facebox_hide").remove();a.$.facebox(d);k();"null"!=typeof e&&"undefined"!=typeof e&&e()};a.message=function(d,e){a.$("body").find(".facebox_hide").remove();
